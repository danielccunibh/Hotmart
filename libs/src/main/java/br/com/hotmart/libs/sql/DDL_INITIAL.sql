...
DROP FOREIGN KEY `PRODUCT_PRODUCT_CATEGORY_FK`;
...
ALTER TABLE `hotmart_challenge`.`PRODUCT` 
ADD COLUMN `SCORE` DOUBLE NOT NULL AFTER `ID_PRODUCT_CATEGORY`;
...
ALTER TABLE `hotmart_challenge`.`SALE` 
ADD COLUMN `DATE_SALE` DATETIME NOT NULL AFTER `ID_PRODUTO`,
ADD COLUMN `AMOUNT` INT(11) NOT NULL AFTER `DATE_SALE`,
ADD COLUMN `EVALUATION` INT(11) NULL DEFAULT NULL AFTER `AMOUNT`,
CHANGE COLUMN `ID` `ID` INT(11) NOT NULL AUTO_INCREMENT ;
...
ALTER TABLE `hotmart_challenge`.`SALE_AUDIT` 
ADD COLUMN `DATE_SALE` DATETIME NOT NULL AFTER `REVTYPE`,
ADD COLUMN `AMOUNT` INT(11) NOT NULL AFTER `DATE_SALE`,
ADD COLUMN `EVALUATION` INT(11) NULL DEFAULT NULL AFTER `AMOUNT`,
CHANGE COLUMN `ID` `ID` INT(11) NOT NULL AUTO_INCREMENT ;
...
CREATE TABLE IF NOT EXISTS `hotmart_challenge`.`PRODUCT_CATEGORY_NEWS` (
...
ALTER TABLE `hotmart_challenge`.`PRODUCT_AUDIT` 
DROP FOREIGN KEY `PRODUCT_AUDIT_PRODUCT_CATEGORY_FK`;

ALTER TABLE `hotmart_challenge`.`PRODUCT_AUDIT` ADD CONSTRAINT `PRODUCT_AUDIT_PRODUCT_FK`
  FOREIGN KEY (`ID`)
  REFERENCES `hotmart_challenge`.`PRODUCT` (`ID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
